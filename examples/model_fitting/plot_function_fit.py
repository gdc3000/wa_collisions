...
# ------------
#
# First, we'll load some data into vehicle_collisions.
...
# ---------------
#
# With vehicle_collisions, models are created with the :ref:Model class.
